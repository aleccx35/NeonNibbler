...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-200 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Header */}
      <div className="z-10 w-full max-w-[500px] flex justify-between items-end mb-2 px-2">
        <div>
          <h1 className="text-4xl font-bold text-white pixel-font tracking-tighter drop-shadow-lg">
      ...
      {/* HUD - Combo Bar */}
      <div className="z-10 w-full max-w-[500px] mb-4 h-8 relative flex items-center justify-between px-2">
         {/* Combo Display */}
      ...
      {/* Status Bar */}
      <div className="z-10 mt-6 w-full max-w-[500px] flex justify-between items-center text-xs text-gray-600 font-mono border-t border-gray-900 pt-4">
